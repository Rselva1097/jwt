...
import com.jwt.token.TokenRepository;
...
public class AuthenticationService {
    ...
    public static void main(String[] arg){
        System.out.println("Issued Time : "+new Date(System.currentTimeMillis())+" Expiration Time : "+new Date(System.currentTimeMillis()+86400000).after(new Date()));
